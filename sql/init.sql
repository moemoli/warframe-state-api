...
-- ============================================================================
-- warframe.market 物品数据（来源：42bytes-team/wfm-items）
-- ============================================================================
CREATE TABLE IF NOT EXISTS public.wfm_items (
...
CREATE TABLE IF NOT EXISTS public.wfm_item_i18n (
    wfm_id      TEXT NOT NULL REFERENCES public.wfm_items(wfm_id) ON DELETE CASCADE,
    lang        TEXT NOT NULL,
    item_name   TEXT,
    description TEXT,
    wiki_link   TEXT,
    PRIMARY KEY (wfm_id, lang)
);

CREATE INDEX IF NOT EXISTS idx_wfm_items_game_ref ON public.wfm_items(game_ref);
CREATE INDEX IF NOT EXISTS idx_wfm_items_slug ON public.wfm_items(slug);
CREATE INDEX IF NOT EXISTS idx_wfm_item_i18n_lang ON public.wfm_item_i18n(lang);
-- 紫卡武器（来源：wfm-items/tracked/rivens/items）
CREATE TABLE IF NOT EXISTS public.wfm_riven_items (
    wfm_id          TEXT PRIMARY KEY,
    slug            TEXT UNIQUE NOT NULL,
    game_ref        TEXT,
    riven_type      TEXT,           -- rifle/pistol/melee/shotgun/zaw/kitgun
    "group"         TEXT,           -- primary/secondary/melee
    disposition     REAL,
    mastery_level   INT,
    icon            TEXT,
    thumb           TEXT
...
CREATE TABLE IF NOT EXISTS public.wfm_riven_item_i18n (
    wfm_id      TEXT NOT NULL REFERENCES public.wfm_riven_items(wfm_id) ON DELETE CASCADE,
    lang        TEXT NOT NULL,
    item_name   TEXT,
    wiki_link   TEXT,
    PRIMARY KEY (wfm_id, lang)
...
-- 紫卡词条（来源：wfm-items/tracked/rivens/attributes）
CREATE TABLE IF NOT EXISTS public.wfm_riven_attributes (
    wfm_id              TEXT PRIMARY KEY,
    slug                TEXT UNIQUE NOT NULL,
    "group"             TEXT,
    prefix              TEXT,
...
CREATE TABLE IF NOT EXISTS public.wfm_riven_attr_i18n (
    wfm_id      TEXT NOT NULL REFERENCES public.wfm_riven_attributes(wfm_id) ON DELETE CASCADE,
    lang        TEXT NOT NULL,
    effect      TEXT,
    PRIMARY KEY (wfm_id, lang)
);

-- 赤毒玄骸武器（来源：wfm-items/tracked/liches/weapons）
CREATE TABLE IF NOT EXISTS public.wfm_lich_weapons (
    wfm_id          TEXT PRIMARY KEY,
    slug            TEXT UNIQUE NOT NULL,
    game_ref        TEXT,
    icon_format     TEXT,
...
CREATE TABLE IF NOT EXISTS public.wfm_lich_weapon_i18n (
    wfm_id      TEXT NOT NULL REFERENCES public.wfm_lich_weapons(wfm_id) ON DELETE CASCADE,
    lang        TEXT NOT NULL,
    item_name   TEXT,
    wiki_link   TEXT,
    PRIMARY KEY (wfm_id, lang)
...
-- 赤毒玄骸幻纹（来源：wfm-items/tracked/liches/ephemeras）
CREATE TABLE IF NOT EXISTS public.wfm_lich_ephemeras (
    wfm_id      TEXT PRIMARY KEY,
    slug        TEXT UNIQUE NOT NULL,
    game_ref    TEXT,
    animation   TEXT,
...
CREATE TABLE IF NOT EXISTS public.wfm_lich_ephemera_i18n (
    wfm_id      TEXT NOT NULL REFERENCES public.wfm_lich_ephemeras(wfm_id) ON DELETE CASCADE,
    lang        TEXT NOT NULL,
    item_name   TEXT,
    wiki_link   TEXT,
    PRIMARY KEY (wfm_id, lang)
...
-- 帕尔沃斯姐妹武器（来源：wfm-items/tracked/sisters/weapons）
CREATE TABLE IF NOT EXISTS public.wfm_sister_weapons (
    wfm_id          TEXT PRIMARY KEY,
    slug            TEXT UNIQUE NOT NULL,
    game_ref        TEXT,
    icon_format     TEXT,
...
CREATE TABLE IF NOT EXISTS public.wfm_sister_weapon_i18n (
    wfm_id      TEXT NOT NULL REFERENCES public.wfm_sister_weapons(wfm_id) ON DELETE CASCADE,
    lang        TEXT NOT NULL,
    item_name   TEXT,
    wiki_link   TEXT,
    PRIMARY KEY (wfm_id, lang)
...
-- 帕尔沃斯姐妹幻纹（来源：wfm-items/tracked/sisters/ephemeras）
CREATE TABLE IF NOT EXISTS public.wfm_sister_ephemeras (
    wfm_id      TEXT PRIMARY KEY,
    slug        TEXT UNIQUE NOT NULL,
    game_ref    TEXT,
    animation   TEXT,
...
CREATE TABLE IF NOT EXISTS public.wfm_sister_ephemera_i18n (
    wfm_id      TEXT NOT NULL REFERENCES public.wfm_sister_ephemeras(wfm_id) ON DELETE CASCADE,
    lang        TEXT NOT NULL,
    item_name   TEXT,
    wiki_link   TEXT,
    PRIMARY KEY (wfm_id, lang)
...
-- 索引
CREATE INDEX IF NOT EXISTS idx_wfm_riven_items_slug ON public.wfm_riven_items(slug);
CREATE INDEX IF NOT EXISTS idx_wfm_riven_items_type ON public.wfm_riven_items(riven_type);
